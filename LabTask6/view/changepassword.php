...
<body>
    ...
    <form action="/labtask6/controller/changepassControl.php" target="_self" method="post" onsubmit="return validchngpass(this)" novalidate>
    ...
    <script>
        function validpass(pass) {
            if (pass == "") { 
                ...
                xhttp.open("POST", "../controller/changepassControl.php");
